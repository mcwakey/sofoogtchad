...
>
    <div class="flex h-full flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3">
            <?php echo $__env->make('admin.partials._sidebar-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </nav>

        
        <div class="border-t border-gray-800 p-4">
            <a href="<?php echo e(url('/')); ?>" target="_blank" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-gray-800 hover:bg-gray-700 transition-colors group">
...
<?php /**PATH C:\dev\projects\web\sofood\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>