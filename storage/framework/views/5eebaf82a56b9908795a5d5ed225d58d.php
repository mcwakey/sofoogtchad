...
<?php $__env->startSection('page-header'); ?>
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <a href="<?php echo e(route('admin.posts.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-700 transition-colors">
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
        <form method="GET" action="<?php echo e(route('admin.posts.index')); ?>" class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="w-full sm:w-40">
                <select name="type" class="block w-full border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500">
                    ...
                    <option value="blog" <?php echo e(request('type') === 'blog' ? 'selected' : ''); ?>>Blog</option>
            ...
            <div class="flex gap-2">
                ...
                <?php if(request()->hasAny(['search', 'type', 'status'])): ?>
                    <a href="<?php echo e(route('admin.posts.index')); ?>" class="px-4 py-2.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors">
                        Clear
                    </a>
                <?php endif; ?>
            </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="h-12 w-16 flex-shrink-0 rounded-lg bg-gray-100 overflow-hidden">
                                        <?php if($post->image_url): ?>
                                            <img src="<?php echo e($post->image_url); ?>" alt="<?php echo e($post->title); ?>" class="h-full w-full object-cover">
                                        <?php else: ?>
                                    ...
                                    <div class="min-w-0">
                                        <div class="text-sm font-medium text-gray-900 truncate max-w-xs"><?php echo e($post->title); ?></div>
                                        <?php if($post->excerpt): ?>
                                            <div class="text-xs text-gray-500 truncate max-w-xs"><?php echo e(Str::limit($post->excerpt, 50)); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($post->type === 'blog' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" x-data="{ showDeleteModal: false }">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('admin.posts.show', $post)); ?>" class="text-blue-500 hover:text-blue-700 transition-colors" title="View Details">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                        </svg>
                                    </a>
                                    <a href="<?php echo e(route('admin.posts.edit', $post)); ?>" class="text-green-600 hover:text-green-700 transition-colors" title="Edit">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="<?php echo e(route('admin.posts.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700 transition-colors">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\projects\web\sofood\resources\views/admin/posts/index.blade.php ENDPATH**/ ?>