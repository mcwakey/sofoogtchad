...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.post-card','data' => ['title' => $post->title,'summary' => $post->excerpt ?? Str::limit($post->content, 150),'image' => $post->image_url,'link' => route('blog.show', $post->slug),'publishedDate' => $post->published_at ?? $post->created_at,'category' => $post->category ?? null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->title),'summary' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->excerpt ?? Str::limit($post->content, 150)),'image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->image_url),'link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('blog.show', $post->slug)),'published_date' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->published_at ?? $post->created_at),'category' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($post->category ?? null)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
