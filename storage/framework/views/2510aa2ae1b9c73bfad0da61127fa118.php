...
<?php $__env->startSection('meta_description', $product->short_description ?? Str::limit(strip_tags($product->description), 160)); ?>
<?php $__env->startSection('og_title', $product->name); ?>
<?php $__env->startSection('og_description', $product->short_description ?? $product->description); ?>
            ...
            <div class="text-center max-w-4xl mx-auto">
                ...
                <nav class="mb-6">
                    <ol class="flex items-center justify-center text-sm text-green-100 gap-2 flex-wrap">
                        <li>
                            <a href="<?php echo e(url('/')); ?>" class="hover:text-white transition-colors">
                        ...
                        <li>/</li>
                        <li>
                            <a href="<?php echo e(route('products.index')); ?>" class="hover:text-white transition-colors">
                                <?php echo e(__('products.title')); ?>
                        ...
                        <?php if($product->category): ?>
                            <li>/</li>
                            <li>
                                <a href="<?php echo e(route('products.category', $product->category->slug)); ?>" class="hover:text-white transition-colors">
                ...
                <span class="inline-flex items-center px-4 py-2 text-sm font-semibold rounded-full
                    <?php echo e($product->type === 'finished' ? 'bg-blue-500/80 text-white' : 'bg-amber-500/80 text-white'); ?>">
    ...
    <section class="py-12 lg:py-16">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div class="space-y-4" x-data="{ activeImage: '<?php echo e($product->image_url ? (Str::startsWith($product->image_url, ['http://', 'https://']) ? $product->image_url : asset($product->image_url)) : ''); ?>' }">
                    
                    <div class="relative aspect-square rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800 shadow-lg">
                        <?php if($product->images->count() > 0 || $product->image_url): ?>
                            <img
                                :src="activeImage"
                    ...
                    <?php if($product->images->count() > 1): ?>
                        <div class="grid grid-cols-4 sm:grid-cols-5 gap-3">
                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <button
                                    @click="activeImage = '<?php echo e($thumbUrl); ?>'"
                                    :class="activeImage === '<?php echo e($thumbUrl); ?>' ? 'ring-2 ring-green-500 ring-offset-2 dark:ring-offset-gray-900' : 'ring-1 ring-gray-200 dark:ring-gray-700'"
                ...
                <div class="space-y-6">
                    ...
                    <?php if($product->sizes->count() > 0): ?>
                        <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                                <?php echo e(__('products.available_sizes')); ?>
                            ...
                            <div class="flex flex-wrap gap-3">
                                <?php $__currentLoopData = $product->sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium
                                        <?php echo e($size->is_default ? 'ring-2 ring-green-500' : ''); ?>">
                                        <?php echo e($size->name); ?>

                                        <?php if($size->value): ?>
                                            <span class="text-gray-500 dark:text-gray-400">(<?php echo e($size->value); ?>)</span>
                                        <?php endif; ?>
                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                    ...
                    <?php if($product->description): ?>
                        <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                                <?php echo e(__('products.description')); ?>
                    ...
                    <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col sm:flex-row gap-4">
                            <?php if(setting('contact_whatsapp')): ?>
                                <a
                                    href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', setting('contact_whatsapp'))); ?>?text=<?php echo e(urlencode(__('products.whatsapp_inquiry', ['product' => $product->name]))); ?>"
                                    target="_blank"
                                ...
                                >
                                    ...
                                    <?php echo e(__('products.inquire_whatsapp')); ?>
            ...
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-4">
                        <?php echo e(__('products.related_products')); ?>

                    </h2>
                    <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                        <?php echo e(__('products.related_products_subtitle')); ?>
                            ...
                            <a href="<?php echo e(route('products.show', $related->slug)); ?>" class="block">
                                <div class="relative aspect-square overflow-hidden bg-gray-100 dark:bg-gray-800">
                                    ...
                                    <span class="absolute top-3 left-3 px-2.5 py-1 text-xs font-semibold rounded-full
                                        <?php echo e($related->type === 'finished' ? 'bg-blue-500 text-white' : 'bg-amber-500 text-white'); ?>">
                                        <?php echo e($related->type_label); ?>
                ...
                <div class="mt-12 text-center">
                    <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-colors">
                        <?php echo e(__('products.view_all_products')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\projects\web\sofood\resources\views/products/show.blade.php ENDPATH**/ ?>