    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="flex-shrink-0">
                <a href="<?php echo e(url('/')); ?>" class="flex items-center" aria-label="<?php echo e($siteName); ?> - Home">
                    <?php if($siteLogo): ?>
                        <img
                        ...
                        >
                    <?php else: ?>
                        <span :class="scrolled ? 'text-green-600 dark:text-green-400' : 'text-white'" class="text-xl lg:text-2xl font-bold transition-colors duration-300"><?php echo e($siteName); ?></span>
                    <?php endif; ?>
                </a>
            </div>

            
            <nav class="hidden lg:flex items-center gap-1" role="navigation" aria-label="<?php echo e(__('navigation.main_navigation')); ?>">
...
<?php endif; ?>
                ...
                <?php if($showCta && $whatsappNumber): ?>
                    <a
                        href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $whatsappNumber)); ?>"
                        target="_blank"
                    ...
                    >
                        ...
                        <span><?php echo e(__('general.whatsapp')); ?></span>
                    </a>
                <?php endif; ?>
            ...
            <?php if($showCta && $whatsappNumber): ?>
                <div class="pt-4 mt-4 border-t border-gray-100 dark:border-gray-800">
                    ...
                    >
                        ...
                        <?php echo e(__('general.contact_whatsapp')); ?>
