...
<footer class="bg-gray-900 text-gray-300" role="contentinfo">
    ...
    <div class="container mx-auto px-4 py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div class="mb-4">
                    <a href="<?php echo e(url('/')); ?>" class="inline-block" aria-label="<?php echo e($siteName); ?>">
                        <?php if($siteLogo): ?>
                            ...
                            >
                        <?php else: ?>
                            <span class="text-2xl font-bold text-white"><?php echo e($siteName); ?></span>
                        <?php endif; ?>
                    </a>
                </div>

                <?php if($siteTagline): ?>
                    <p class="text-gray-400 text-sm mb-6"><?php echo e($siteTagline); ?></p>
                <?php endif; ?>

                
                <div class="flex items-center gap-3">
                    <?php $__currentLoopData = $socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform => $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($social['url']): ?>
                            <a
                                ...
                                aria-label="<?php echo e(__('general.follow_us')); ?> <?php echo e($social['label']); ?>"
                            >
                                <?php switch($platform):
                                    case ('facebook'): ?>
            ...
            <div>
                <h3 class="text-white font-semibold text-lg mb-4"><?php echo e(__('general.quick_links')); ?></h3>
                <ul class="space-y-3">
                    <?php $__currentLoopData = $quickLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(url($link['route'])); ?>" class="text-gray-400 hover:text-green-400 transition-colors duration-200">
            ...
            <div>
                <h3 class="text-white font-semibold text-lg mb-4"><?php echo e(__('general.company')); ?></h3>
                <ul class="space-y-3">
            ...
            <div>
                <h3 class="text-white font-semibold text-lg mb-4"><?php echo e(__('general.contact_us')); ?></h3>
                <ul class="space-y-4">
                    <?php if($contactAddress): ?>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-gray-400 text-sm"><?php echo e($contactAddress); ?></span>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if($contactPhone): ?>
                        <li class="flex items-center gap-3">
                            ...
                            <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $contactPhone)); ?>" class="text-gray-400 hover:text-green-400 transition-colors duration-200 text-sm">
                    ...
                    <!-- <?php if($contactWhatsapp): ?>
                        <li class="flex items-center gap-3">
                            ...
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $contactWhatsapp)); ?>" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-green-400 transition-colors duration-200 text-sm">
                                <?php echo e($contactWhatsapp); ?>
                    ...
                    <?php if($contactEmail): ?>
                        <li class="flex items-center gap-3">
                            ...
                            <a href="mailto:<?php echo e($contactEmail); ?>" class="text-gray-400 hover:text-green-400 transition-colors duration-200 text-sm">
                    ...
                    <?php if($workingHours): ?>
                        <li class="flex items-center gap-3">
                            ...
                            <span class="text-gray-400 text-sm"><?php echo e($workingHours); ?></span>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
    ...
    <div class="border-t border-gray-800">
        <div class="container mx-auto px-4 py-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <p class="text-gray-500 text-sm text-center md:text-<?php echo e(app()->getLocale() === 'ar' ? 'right' : 'left'); ?>">
                    &copy; <?php echo e($currentYear); ?> <?php echo e($siteName); ?>. <?php echo e(__('general.all_rights_reserved')); ?>

                    <span class="mx-2">|</span>
                    <?php echo e(__('general.designed_by')); ?>
                ...
                <ul class="flex items-center justify-center gap-6">
                    <?php $__currentLoopData = $legalLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(url($link['route'])); ?>" class="text-gray-500 hover:text-gray-300 text-sm transition-colors duration-200">
                                <?php echo e($link['label']); ?>
...
<?php /**PATH C:\dev\projects\web\sofood\resources\views/components/footer.blade.php ENDPATH**/ ?>