...
<?php $__env->startSection('page-header'); ?>
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <a href="<?php echo e(route('admin.settings.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-700 transition-colors">
        ...
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="flex overflow-x-auto scrollbar-hide" aria-label="Tabs">
                <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('admin.settings.index', ['group' => $group])); ?>"
                       class="flex-shrink-0 px-6 py-4 text-sm font-medium border-b-2 transition-colors <?php echo e($activeGroup === $group ? 'border-green-500 text-green-600 dark:text-green-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300'); ?>">
                ...
                <a href="<?php echo e(route('admin.settings.index', ['group' => 'legal'])); ?>"
                   class="flex-shrink-0 px-6 py-4 text-sm font-medium border-b-2 transition-colors <?php echo e($activeGroup === 'legal' ? 'border-green-500 text-green-600 dark:text-green-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300'); ?>">
                    <span class="flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        ...
                        <?php if(isset($privacyPolicy) && $privacyPolicy->status === 'published'): ?>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                <?php if(isset($privacyPolicy) && $privacyPolicy->updated_at): ?>
                                    <span class="flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                        Updated <?php echo e($privacyPolicy->updated_at->diffForHumans()); ?>
                            ...
                            <a href="<?php echo e(route('admin.legal.privacy')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        ...
                        <?php if(isset($termsOfService) && $termsOfService->status === 'published'): ?>
                            <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                                <span class="w-1.5 h-1.5 rounded-full bg-green-500"></span>
                                Published
                            </span>
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                <?php if(isset($termsOfService) && $termsOfService->updated_at): ?>
                                    <span class="flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                        Updated <?php echo e($termsOfService->updated_at->diffForHumans()); ?>
                            ...
                            <a href="<?php echo e(route('admin.legal.terms')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                                Edit
        ...
        <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('legal.privacy')); ?>" target="_blank" class="inline-flex items-center gap-2 text-sm text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                        </svg>
                        View Privacy Policy
                    </a>
                    <a href="<?php echo e(route('legal.terms')); ?>" target="_blank" class="inline-flex items-center gap-2 text-sm text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                        </svg>
    ...
    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div class="p-6">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="lg:col-span-1">
                                <label for="settings_<?php echo e($setting->key); ?>" class="block text-sm font-semibold text-gray-900 dark:text-white">
                                    <?php echo e($setting->label ?: ucwords(str_replace('_', ' ', $setting->key))); ?>

                                </label>
                                <?php if($setting->description): ?>
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400"><?php echo e($setting->description); ?></p>
                                <?php endif; ?>
                                <div class="mt-2 flex items-center gap-2">
                                    <code class="text-xs text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded"><?php echo e($setting->key); ?></code>
                            ...
                            <div class="lg:col-span-2">
                                <?php switch($setting->type):
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                ...
                                                <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">
                                                    <?php echo e(old("settings.{$setting->key}", $setting->value) ? 'Enabled' : 'Disabled'); ?>
                                    ...
                                    <?php case ('json'): ?>
                                        ...
                                        ><?php echo e(old("settings.{$setting->key}", is_array($setting->value) ? json_encode($setting->value, JSON_PRETTY_PRINT) : $setting->value)); ?></textarea>
                                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Enter valid JSON format</p>
                                        <?php break; ?>

                                    <?php case ('image'): ?>
                                        <div x-data="{
                                            preview: '<?php echo e($setting->value); ?>',
                                            fileSelected: false,
                                            removeImage() {
                                                if (confirm('Are you sure you want to remove this image?')) {
                                                    fetch('<?php echo e(route('admin.settings.remove-image')); ?>', {
                                                        method: 'POST',
                                                        headers: {
                                                            'Content-Type': 'application/json',
                                                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                                                        },
                                                        body: JSON.stringify({ key: '<?php echo e($setting->key); ?>' })
                                                    })
                                            ...
                                            <div x-show="preview && !fileSelected" class="relative">
                                                <div class="flex items-start gap-4">
                                                    <div class="relative group">
                                                        <img
                                                            :src="preview"
                                                            alt="Current <?php echo e($setting->label); ?>"
                                            ...
                                            <div class="relative">
                                                <label
                                                    for="images_<?php echo e($setting->key); ?>"
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        type="file"
                                                        name="images[<?php echo e($setting->key); ?>]"
                                                        id="images_<?php echo e($setting->key); ?>"
                                                        accept="image/*,.ico"
                                                        class="hidden"
                                                        @change="
                                                            fileSelected = true;
                                            ...
                                            <div x-show="fileSelected && preview" class="flex items-center gap-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                                ...
                                                <button
                                                    type="button"
                                                    @click="fileSelected = false; preview = '<?php echo e($setting->value); ?>'; document.getElementById('images_<?php echo e($setting->key); ?>').value = ''"
                    ...
                    <div class="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700 flex items-center justify-end gap-4">
                        <a href="<?php echo e(route('admin.settings.edit', $setting)); ?>" class="inline-flex items-center gap-1 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                            Edit
                                    ...
                                    <div class="flex min-h-full items-center justify-center p-4">
                                        ...
                                        >
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <p class="text-lg font-medium text-gray-900 dark:text-white mb-4">"<?php echo e($setting->label ?: $setting->key); ?>"?</p>
                                            ...
                                            <div class="p-6 pt-0 flex gap-3">
                                                ...
                                                <form action="<?php echo e(route('admin.settings.destroy', $setting)); ?>" method="POST" class="flex-1">
                                                    <?php echo csrf_field(); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Get started by creating your first setting in the "<?php echo e(ucfirst($activeGroup)); ?>" group.</p>
                        <a href="<?php echo e(route('admin.settings.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-700 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
        ...
        <?php if($settings->count() > 0): ?>
            <div class="mt-6 flex items-center justify-end gap-4">
                <a href="<?php echo e(route('admin.settings.index', ['group' => $activeGroup])); ?>" class="px-4 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                    Cancel
                </a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\projects\web\sofood\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>