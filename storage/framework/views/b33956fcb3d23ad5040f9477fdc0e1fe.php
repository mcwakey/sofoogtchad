<?php $__env->startSection('title', trans_setting('site_name', 'Sofoodtchad') . ' - ' . __('process.title')); ?>

<?php $__env->startSection('meta_description', trans_setting('process_meta_description', __('process.description'))); ?>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                <span class="inline-block text-green-200 font-semibold text-sm uppercase tracking-wider mb-4">
                    <?php echo e(trans_setting('process_page_subtitle', __('process.subtitle'))); ?>

                </span>
                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
                    <?php echo e(trans_setting('process_page_title', __('process.title'))); ?>

                </h1>
                <p class="text-lg text-green-100">
                    <?php echo e(trans_setting('process_page_description', __('process.description'))); ?>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="text-center mb-16">
                    <span class="inline-block text-green-600 dark:text-green-400 font-semibold text-sm uppercase tracking-wider mb-2">
                        <?php echo e(trans_setting('process_steps_subtitle', __('process.step_by_step'))); ?>

                    </span>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">
                        <?php echo e(trans_setting('process_steps_title', __('process.how_we_ensure_quality'))); ?>
                ...
                <div class="hidden lg:block">
                    <div class="relative">
                        ...
                        <div class="grid grid-cols-<?php echo e(min($steps->count(), 6)); ?> gap-4 relative">
                                ...
                                <div class="flex flex-col items-center text-center">
                                    ...
                                    <div class="relative z-10 w-32 h-32 bg-white dark:bg-gray-800 rounded-full shadow-xl dark:shadow-gray-900/50 flex items-center justify-center mb-6 border-4 border-green-500">
                                        <div class="text-center">
                                            <span class="block text-4xl font-bold text-green-600 dark:text-green-400"><?php echo e(str_pad($step->sort_order ?? $index + 1, 2, '0', STR_PAD_LEFT)); ?></span>
                                        </div>
                                    </div>

                                    
                                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($step->title); ?></h3>
                                    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed"><?php echo e($step->description); ?></p>
                                </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8">
                            <div class="flex items-start gap-6">
                                ...
                                <div class="flex-shrink-0 w-16 h-16 bg-green-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                                    <?php echo e(str_pad($step->sort_order ?? $index + 1, 2, '0', STR_PAD_LEFT)); ?>

                                </div>

                                
                                <div class="flex-1">
                                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($step->title); ?></h3>
                                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed"><?php echo e($step->description); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative flex items-start gap-6 pl-4">
                                    ...
                                    <div class="relative z-10 flex-shrink-0 w-12 h-12 bg-green-600 rounded-full flex items-center justify-center text-white text-lg font-bold shadow-lg ring-4 ring-white dark:ring-gray-900">
                                        <?php echo e($step->sort_order ?? $index + 1); ?>

                                    </div>

                                    
                                    <div class="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/30 p-5">
                                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2"><?php echo e($step->title); ?></h3>
                                        <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed"><?php echo e($step->description); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <span class="inline-block text-green-600 dark:text-green-400 font-semibold text-sm uppercase tracking-wider mb-2">
                        <?php echo e(trans_setting('quality_commitment_subtitle', __('process.our_promise'))); ?>

                    </span>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
                        <?php echo e(trans_setting('quality_commitment_title', __('process.quality_you_can_trust'))); ?>

                    </h2>
                    <div class="prose prose-lg text-gray-600 dark:text-gray-300 mb-8">
                        <p><?php echo e(trans_setting('quality_commitment_description', __('process.quality_description'))); ?></p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        ?>
                        <?php $__currentLoopData = $qualityFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-start gap-3 p-4 bg-white dark:bg-gray-700 rounded-xl shadow-sm dark:shadow-gray-900/30">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white"><?php echo e($feature['title']); ?></h4>
                ...
                <div class="relative">
                    <img
                        src="<?php echo e(setting('quality_commitment_image', 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=600&h=500&fit=crop')); ?>"
                        alt="Quality Process"
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                ...
                <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="text-4xl md:text-5xl font-bold text-white mb-2"><?php echo e($stat['value']); ?></div>
                        <div class="text-green-100"><?php echo e($stat['label']); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <section class="py-20 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                <?php echo e(trans_setting('process_cta_title', __('process.experience_quality'))); ?>

            </h2>
            <p class="text-gray-600 dark:text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
                <?php echo e(trans_setting('process_cta_description', __('process.experience_quality_desc'))); ?>

            </p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="<?php echo e(route('products.index')); ?>" class="px-8 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors duration-200">
                    <?php echo e(__('process.explore_products')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\projects\web\sofood\resources\views/process/index.blade.php ENDPATH**/ ?>