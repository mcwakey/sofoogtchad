<?php $__env->startSection('title', ($post->meta_title ?? $post->title) . ' - ' . trans_setting('site_name', 'Sofoodtchad')); ?>
...
<?php if($post->featured_image): ?>
    <?php $__env->startSection('og_image', $post->image_url); ?>
<?php endif; ?>
            ...
            <div class="text-center max-w-4xl mx-auto">
                ...
                <nav class="mb-6">
                    <ol class="flex items-center justify-center text-sm text-green-100 gap-2">
                        ...
                        <li>/</li>
                        <li>
                            <a href="<?php echo e(route('blog.index')); ?>" class="hover:text-white transition-colors">
                ...
                <span class="inline-block px-4 py-1.5 text-xs font-semibold uppercase tracking-wider rounded-full mb-4
                    <?php echo e($post->type === 'news' ? 'bg-blue-500/80 text-white' : 'bg-white/20 text-white'); ?>">
                ...
                <div class="flex items-center justify-center gap-4 text-green-100 text-sm">
                    ...
                    <span><?php echo e(__('blog.by')); ?> <?php echo e($post->author->name ?? 'Admin'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <?php if($post->images->count()): ?>
                <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6"><?php echo e(__('blog.gallery')); ?></h3>
                        ...
                        <?php $__currentLoopData = $post->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="relative aspect-square rounded-xl overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-shadow duration-300">
                                <img
                                    ...
                                    alt="<?php echo e($image->alt_text ?? $post->title); ?>"
            ...
            <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
                <a href="<?php echo e(route('blog.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-colors shadow-md hover:shadow-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                    </svg>
                    <?php echo e(__('blog.back_to_blog')); ?>
        ...
        <section class="py-16 bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white text-center mb-10">
                    <?php echo e(__('blog.related_posts')); ?>
                    ...
                    <?php $__currentLoopData = $relatedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300 group">
                            <?php if($related->featured_image): ?>
                                <a href="<?php echo e(route('blog.show', $related->slug)); ?>" class="block relative aspect-video overflow-hidden">
                                    <img
                                    ...
                                    <span class="absolute top-3 left-3 px-3 py-1 text-xs font-semibold uppercase tracking-wider rounded-full
                                        <?php echo e($related->type === 'news' ? 'bg-blue-500 text-white' : 'bg-green-500 text-white'); ?>">
                                        <?php echo e(ucfirst($related->type)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\projects\web\sofood\resources\views/blog/show.blade.php ENDPATH**/ ?>