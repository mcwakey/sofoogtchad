        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 lg:p-12">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">Our privacy policy is being prepared and will be available shortly.</p>
                    </div>
                @endif
            </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-600 dark:text-gray-400">
                    ...
                    <a href="{{ route('contact.index') }}" class="text-green-600 dark:text-green-400 hover:underline font-medium">{{ __('general.contact_us') }}</a>
                </p>
            </div>
        </div>
    </section>
