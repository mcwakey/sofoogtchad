            ...
            <div class="flex-shrink-0">
                <a href="{{ url('/') }}" class="flex items-center" aria-label="{{ $siteName }} - Home">
                    @if($siteLogo)
                        ...
                        >
                    @else
                        <span class="text-xl lg:text-2xl font-bold text-green-600">{{ $siteName }}</span>
                    @endif
                </a>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                @if($showCta && $whatsappNumber)
                    <a
                        ...
                        class="hidden sm:inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors duration-200"
                ...
                <button
                    type="button"
                    class="lg:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-green-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500"
            ...
            @if($showCta && $whatsappNumber)
                <div class="pt-4 mt-4 border-t border-gray-100">
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        class="flex items-center justify-center gap-2 w-full px-4 py-3 bg-green-600 text-white text-base font-medium rounded-lg hover:bg-green-700 transition-colors duration-200"
                    >
