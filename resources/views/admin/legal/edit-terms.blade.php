...
@section('page-title', 'Edit Terms of Service')
...
@section('page-header')
    <div class="sm:flex sm:items-center sm:justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Terms of Service</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Define the rules for using your website</p>
            </div>
        </div>
        <div class="mt-4 sm:mt-0">
            <a href="{{ route('legal.terms') }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.legal.terms.update') }}" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="title"
                        name="title"
                        value="{{ old('title', $page->title ?? 'Terms of Service') }}"
                        required
