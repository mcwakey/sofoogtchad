    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Define a new user role</p>
            </div>
        </div>
    </div>
@endsection
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                            After creating the role, you can assign it to users from their profile or the users list.
                        </p>
                    </div>
                </div>
            </div>
