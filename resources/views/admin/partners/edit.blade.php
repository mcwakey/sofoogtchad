                    ...
                    <div x-data="{ imagePreview: null }">
                        ...
                        <div class="flex items-center justify-center w-full">
                            ...
                            <div x-show="imagePreview" class="relative w-full">
                                <div class="w-full h-40 bg-green-50 border-2 border-green-300 rounded-lg flex items-center justify-center p-4">
                ...
                <div class="bg-gray-50 rounded-xl border border-gray-200 p-6">
                    ...
                    <dl class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <dd class="text-gray-900">{{ $partner->created_at->format('M d, Y') }}</dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-gray-500">Updated</dt>
                            <dd class="text-gray-900">{{ $partner->updated_at->format('M d, Y') }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
